...
export default function WideCard({ image, title, description }) {
  return (
    <article>
      <figure className="group relative flex h-max min-w-[250px] max-w-min flex-wrap overflow-hidden rounded-lg border-2 border-sutilBlack bg-sutilBlack font-Raleway text-white md:max-h-min md:max-w-2xl md:flex-nowrap">
        <img
